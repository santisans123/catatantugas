                    ...
                    <v-list-item>
                        ...
                        <v-expand-transition>
                            <div v-show="show">
                                    ...
                                    <input  class="jadwal3 ml-5" v-model="senin3">
                            </div>
                        </v-expand-transition>
                        ...
                        <v-expand-transition> 
                            <div v-show="show">
                                ...
                                <input  class="jadwal3 ml-5" v-model="selasa3">
                            </div>
                        </v-expand-transition>
                      ...
                      <v-expand-transition>
                            <div v-show="show">
                                ...
                                <input  class="jadwal3 ml-5" v-model="rabu3">
                            </div>
                        </v-expand-transition>
                        ...
                        <v-expand-transition>
                            <div v-show="show">
                                ...
                                <input  class="jadwal3 ml-5" v-model="kamis3">
                            </div>
                        </v-expand-transition>
                        ...
                        <v-expand-transition>
                            <div v-show="show">
                                ...
                                <input  class="jadwal3 ml-5" v-model="jumat3">
                            </div>
                        </v-expand-transition>
                        <v-col
                            cols="12"
